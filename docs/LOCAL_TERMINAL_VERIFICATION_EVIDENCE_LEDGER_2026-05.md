...
| --- | --- | --- | --- | --- |
| `formatting` | Yes | `dart format example/lib example/test` | passed | `build/local-terminal-verification/20260516T145142Z-all-automated`: exit 0; `Formatted 252 files (0 changed)`. |
