...
- `flutter test -d macos integration_test/ianvs_terminal_smoke_test.dart` passed on macOS, though the run still printed `Failed to foreground app; open returned 1`.
