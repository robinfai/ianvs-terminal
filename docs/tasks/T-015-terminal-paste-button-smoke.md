...
- `app/integration_test/flutterm_smoke_test.dart`（首选）
- `app/test/widget_test.dart`（仅当需要更稳定的剪贴板控制时二选一替代）
- `docs/tasks/T-015-terminal-paste-button-smoke.md`
