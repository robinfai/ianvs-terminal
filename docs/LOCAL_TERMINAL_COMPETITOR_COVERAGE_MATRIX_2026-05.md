...
| --- | --- | --- | --- | --- | --- | --- |
| Versioned local config, import-like layering, reload boundaries | Alacritty, Ghostty, WezTerm | P1 | T-080, T-081, T-102, T-124, T-125 | `local_terminal_config_models.dart`, `local_terminal_config_repository.dart`, `local_terminal_config_bootstrap.dart`, `local_terminal_config_loader.dart`, `local_terminal_config_preferences_adapter.dart` | Foundation | Wire config loading into app startup/session creation and verify old profile/preferences fallback. |
