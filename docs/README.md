...
- [DECISIONS/ADR-0004-client-side-sensitive-encryption.md](DECISIONS/ADR-0004-client-side-sensitive-encryption.md)：Data API 客户端专属主密钥、敏感字段 AEAD 信封与服务端不透明存储边界。
