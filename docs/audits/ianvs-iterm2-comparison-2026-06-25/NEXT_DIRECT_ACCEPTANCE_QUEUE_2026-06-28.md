...
Next handle shell/status and diagnostics surfaces. Leave visual polish such as tab color and broader focus/semantics sweeps until after the profile workflow is no longer accumulating structural debt.
