...
run_logged_command "$SMOKE_TIMEOUT_SECONDS" "$SMOKE_LOG" flutter test integration_test/ianvs_smoke_test.dart
smoke_exit=$?
...
- \`command -v vttest\`: $vttest_status
  - $vttest_detail
- \`flutter test integration_test/ianvs_smoke_test.dart\`: $smoke_status
  - $smoke_detail
  - log: $SMOKE_LOG
...
- \`command -v vttest\`: $vttest_status
  - $vttest_detail
- \`integration_test/ianvs_smoke_test.dart\`: $smoke_status
  - $smoke_detail
  - log: $SMOKE_LOG
- \`flutter run -d macos\`: $run_status
  - $run_detail
