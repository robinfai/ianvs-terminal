...
abstract class AppLocalizations {
  ...
  /// No description provided for @replayHubTitle.
  ///
  /// In en, this message translates to:
  /// **'Replay'**
  String get replayHubTitle;

  /// No description provided for @replayHubDescription.
  ///
  /// In en, this message translates to:
  /// **'Review recent screen history, saved recordings, or open a recording file.'**
  String get replayHubDescription;

  /// No description provided for @replayRecentTitle.
  ///
  /// In en, this message translates to:
  /// **'Recent screen history'**
  String get replayRecentTitle;

  /// No description provided for @replayRecentExplanation.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @replayRecentNeedsSession.
  ///
  /// In en, this message translates to:
  /// **'Open a terminal session to review its recent screen history.'**
  String get replayRecentNeedsSession;

  /// No description provided for @replaySavedExplanation.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @replayOpenFile.
  ///
  /// In en, this message translates to:
  /// **'Open recording file'**
  String get replayOpenFile;

  /// No description provided for @replayLibraryEmpty.
  ///
  /// In en, this message translates to:
  /// **'No saved recordings yet. Start and stop a recording, or open a recording file.'**
  String get replayLibraryEmpty;

  /// No description provided for @replayRecordingUnavailable.
  ///
  /// In en, this message translates to:
