...
class ShellActionRegistry {
  ...
  static const Map<TerminalActionId, TerminalActionDescriptor> actions = {
    ...
    TerminalActionId.previousCommandBlock: TerminalActionDescriptor(
      id: TerminalActionId.previousCommandBlock,
      label: 'previous_command_block',
      category: TerminalActionCategory.navigation,
      shortcutHint: '↑ when block selected',
      terminalInputPolicy: TerminalInputPolicy.appFirst,
      icon: Icons.keyboard_double_arrow_up,
      requiresActiveSession: true,
    ),
    TerminalActionId.nextCommandBlock: TerminalActionDescriptor(
      id: TerminalActionId.nextCommandBlock,
      label: 'next_command_block',
      category: TerminalActionCategory.navigation,
      shortcutHint: '↓ when block selected',
      terminalInputPolicy: TerminalInputPolicy.appFirst,
