      ...
      child: Padding(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final timeline = Column(
              ...
              children: [
                ...
                Slider(
                  ...
                  value: timelineValue.clamp(0.0, timelineMax).toDouble(),
                  min: 0,
                  max: timelineMax,
                  label: frameCount <= 1
                      ? 'Latest frame'
            ...
            final closeButton = _buildSheetCloseButton(
    ...
    return SizedBox(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final usableWidth = math.max(0.0, width - 6);
              ...
              Stack(
                ...
                children: [
                  for (final value in changeMarkerValues)
                    Positioned(
                      left: (value / safeMax).clamp(0.0, 1.0) * usableWidth,
                      top: 2,
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          color: palette.accent,
                        ...
                        child: const SizedBox(width: 6, height: 12),
                      ),
                    ),
                ],
              ),
