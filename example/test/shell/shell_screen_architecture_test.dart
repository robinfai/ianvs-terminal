...
Iterable<File> _allowedShellExternalDependencies(Directory libDirectory) {
  const paths = <String>[
    ...
    'data/sync/api_sync_panel.dart',
    'data/sync/local_first_sync.dart',
    ...
    'platform/terminal_graphic_image_actions.dart',
    'ui/app_ui.dart',
    'ui/foundation/app_theme_tokens.dart',
    ...
    'features/sessions/shell_capabilities_dialog.dart',
    ...
    'features/terminal/selection_resize_guard.dart',
